...
import (
	...
	api "github.com/khulnasoft/devtool/devtool-protocol"
...
func init() {
	...
	usersCmd.PersistentFlags().StringVar(&usersCmdOpts.address, "address", "wss://devtool.io/api/v1", "Address of the API endpoint. Must be in the form <host>:<port>.")
