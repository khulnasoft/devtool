...
var (
	holder    = flag.String("c", "Devtool GmbH", "copyright holder")
...
func removeLicense(path string, fmode os.FileMode, tmpl *template.Template, data *copyrightData) (haslic bool, modified bool, err error) {
	...
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2021 Devtool GmbH."), []byte("Copyright (c) 2022 Devtool GmbH."))
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2020 Devtool GmbH."), []byte("Copyright (c) 2022 Devtool GmbH."))
