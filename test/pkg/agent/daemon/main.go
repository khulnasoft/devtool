...
import (
	...
	cgroups_v2 "github.com/khulnasoft/devtool/common-go/cgroups/v2"
	ctntcfg "github.com/khulnasoft/devtool/content-service/api/config"
	"github.com/khulnasoft/devtool/content-service/pkg/storage"
	"github.com/khulnasoft/devtool/test/pkg/agent/daemon/api"
...
func (*DaemonAgent) VerifyRateLimitingRule(args *api.VerifyRateLimitingRuleRequest, resp *api.VerifyRateLimitingRuleResponse) error {
	*resp = api.VerifyRateLimitingRuleResponse{}
	...
	// Check if set exists.
	_, err = nftconn.GetSetByName(devtoolTable, "ws-connections")
	if err != nil {
