...
func init() {
	...
	ideConfigmapCmd.PersistentFlags().StringVarP(&ideOpts.ConfigFN, "config", "c", getEnvvar("DEVTOOL_INSTALLER_CONFIG", filepath.Join(dir, "devtool.config.yaml")), "path to the config file, use - for stdin")
