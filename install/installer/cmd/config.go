...
func init() {
	...
	configCmd.PersistentFlags().StringVarP(&configOpts.ConfigFile, "config", "c", getEnvvar("DEVTOOL_INSTALLER_CONFIG", filepath.Join(dir, "devtool.config.yaml")), "path to the configuration file")
}
