...
func init() {
	...
	validateClusterCmd.PersistentFlags().StringVarP(&validateClusterOpts.Config, "config", "c", getEnvvar("DEVTOOL_INSTALLER_CONFIG", filepath.Join(dir, "devtool.config.yaml")), "path to the config file")
