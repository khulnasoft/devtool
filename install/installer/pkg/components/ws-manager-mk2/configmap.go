...
import (
	...
	wsdaemon "github.com/khulnasoft/devtool/installer/pkg/components/ws-daemon"
	"sigs.k8s.io/yaml"

	"github.com/khulnasoft/devtool/common-go/grpc"
	"github.com/khulnasoft/devtool/common-go/util"
	storageconfig "github.com/khulnasoft/devtool/content-service/api/config"
...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	devtoolHostURL := "https://" + ctx.Config.Domain
	...
	err = ctx.WithExperimental(func(ucfg *experimental.Config) error {
		...
		if ucfg.Workspace.HostURL != "" {
			devtoolHostURL = ucfg.Workspace.HostURL
		}
	...
	if ctx.Config.Kind == configv1.InstallationWorkspace {
		...
		// (https://github.com/khulnasoft/devtool/issues/7845).
