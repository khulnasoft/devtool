...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	counterMetrics := []config.CounterMetricsConfiguration{
		...
		{
			Name: "devtool_supervisor_frontend_error_total",
		...
		{
			Name: "devtool_vscode_web_load_total",
		...
		{
			Name: "devtool_supervisor_frontend_client_total",
			Help: "Total count of supervisor frontend client",
		},
		{
			Name: "devtool_vscode_extension_gallery_operation_total",
		...
		{
			Name: "devtool_vscode_extension_gallery_query_total",
		...
		},
		{
			...
			Labels: []config.LabelAllowList{
				{
					Name:         "origin",
					AllowValues:  []string{"unknown", "workspace", "devtool", "localhost"},
					DefaultValue: "unknown",
				},
				{
					Name:         "instance_phase",
	...
	histogramMetrics := []config.HistogramMetricsConfiguration{
		{
			Name: "devtool_vscode_extension_gallery_operation_duration_seconds",
			...
			Name: "devtool_vscode_extension_gallery_query_duration_seconds",
