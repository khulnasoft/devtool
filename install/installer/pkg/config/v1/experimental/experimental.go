...
// outside of Devtool to use.
//
// Changes in this section will NOT be backwards compatible change at will without prior notice.
// If you use any setting herein, you forfeit support from Devtool.
package experimental

import (
	"time"

	agentSmith "github.com/khulnasoft/devtool/agent-smith/pkg/config"
	"github.com/khulnasoft/devtool/common-go/grpc"
	db "github.com/khulnasoft/devtool/components/devtool-db/go"
	"github.com/khulnasoft/devtool/ws-daemon/pkg/cpulimit"
...
type WorkspaceConfig struct {
	...
	WSProxy struct {
		...
		DevtoolInstallationHostName                 string `json:"devtoolInstallationHostName"`
		DevtoolInstallationWorkspaceHostSuffix      string `json:"devtoolInstallationWorkspaceHostSuffix"`
		DevtoolInstallationWorkspaceHostSuffixRegex string `json:"devtoolInstallationWorkspaceHostSuffixRegex"`
	} `json:"wsProxy"`
...
type WebAppConfig struct {
	...
	// PublicURL lets you override the publically reachable endpoints of devtool (currently only public api endpoint)
	...
	// ProxySettings is used if the devtool cell uses some proxy for connectivity
