...
import (
	...
	"github.com/khulnasoft/devtool/installer/pkg/containerd"
...
var (
	defaultRepositoryUrl = config.DevtoolContainerRegistry
)
...
// Taken from github.com/khulnasoft/devtool/components/devtool-protocol/src/util/logging.ts
const (
