...
func TestPublicApiServerComponentWaiterContainer(t *testing.T) {
	...
	ctx.Config.Repository = "eu.gcr.io/devtool-core-dev/testing/installer"
	...
	require.Equal(t, labels, "app=devtool,component=public-api-server")
...
func TestServerComponentWaiterContainer(t *testing.T) {
	...
	require.Equal(t, labels, "app=devtool,component=server")
...
func TestConfigcatEnvOutOfCluster(t *testing.T) {
	...
	require.Equal(t, envVars, []v1.EnvVar([]v1.EnvVar{{Name: "CONFIGCAT_SDK_KEY", Value: "devtool"}, {Name: "CONFIGCAT_BASE_URL", Value: "https://devtool.io/configcat"}}))
}
