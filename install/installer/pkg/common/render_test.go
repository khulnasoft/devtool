...
import (
	...
	content_service "github.com/khulnasoft/devtool/installer/pkg/components/content-service"
...
func TestRepoName(t *testing.T) {
	...
	tests := []struct {
		...
		// Drop repo, namespace
		{
			Name: "khulnasoft/workspace-full",
			Expectation: Expectation{
				Result: "some.registry.com/devtool/workspace-full",
			},
			CfgRepo:       "some.registry.com/devtool",
			DropImageRepo: pointer.Bool(true),
		},
		{
			Repo: "some-repo.com",
			Name: "some-image",
			Expectation: Expectation{
				Result: "some.registry.com/devtool/some-image",
			},
			CfgRepo:       "some.registry.com/devtool",
			DropImageRepo: pointer.Bool(true),
		},
