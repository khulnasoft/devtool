(() => {
    ...
    const replacements = [
        { from: './content-service-api/initializer_pb.js', to: '@devtool/content-service/lib' },
        { from: './content-service-api/initializer_pb', to: '@devtool/content-service/lib' },
        { from: './content-service-api/blobs_pb.js', to: '@devtool/content-service/lib' },
        { from: './content-service-api/blobs_pb', to: '@devtool/content-service/lib' }
    ]
