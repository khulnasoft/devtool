...
export const DevtoolServer = Symbol("DevtoolServer");
export interface DevtoolServer extends JsonRpcServer<DevtoolClient>, AdminServer, IDEServer {
    // User related API
    ...
    getToken(query: DevtoolServer.GetTokenSearchOptions): Promise<Token | undefined>;
    getDevtoolTokenScopes(tokenHash: string): Promise<string[]>;
    ...
    updateOwnAuthProvider(params: DevtoolServer.UpdateOwnAuthProviderParams): Promise<AuthProviderEntry>;
    deleteOwnAuthProvider(params: DevtoolServer.DeleteOwnAuthProviderParams): Promise<void>;
    // org-level
    createOrgAuthProvider(params: DevtoolServer.CreateOrgAuthProviderParams): Promise<AuthProviderEntry>;
    updateOrgAuthProvider(params: DevtoolServer.UpdateOrgAuthProviderParams): Promise<AuthProviderEntry>;
    getOrgAuthProviders(params: DevtoolServer.GetOrgAuthProviderParams): Promise<AuthProviderEntry[]>;
    deleteOrgAuthProvider(params: DevtoolServer.DeleteOrgAuthProviderParams): Promise<void>;
    ...
    getWorkspaces(options: DevtoolServer.GetWorkspacesOptions): Promise<WorkspaceInfo[]>;
     ...
     * @param options DevtoolServer.CreateWorkspaceOptions
     * @return WorkspaceCreationResult
     */
    createWorkspace(options: DevtoolServer.CreateWorkspaceOptions): Promise<WorkspaceCreationResult>;
    startWorkspace(id: string, options: DevtoolServer.StartWorkspaceOptions): Promise<StartWorkspaceResult>;
    stopWorkspace(id: string): Promise<void>;
    deleteWorkspace(id: string): Promise<void>;
    setWorkspaceDescription(id: string, desc: string): Promise<void>;
    controlAdmission(id: string, level: DevtoolServer.AdmissionLevel): Promise<void>;
    resolveContext(contextUrl: string): Promise<WorkspaceContext>;

    updateWorkspaceUserPin(id: string, action: DevtoolServer.PinAction): Promise<void>;
    sendHeartBeat(options: DevtoolServer.SendHeartBeatOptions): Promise<void>;
    ...
    getOnboardingState(): Promise<DevtoolServer.OnboardingState>;
    ...
    // Devtool token
    getDevtoolTokens(): Promise<DevtoolToken[]>;
    generateNewDevtoolToken(options: DevtoolServer.GenerateNewDevtoolTokenOptions): Promise<string>;
    deleteDevtoolToken(tokenHash: string): Promise<void>;
     ...
     */
    takeSnapshot(options: DevtoolServer.TakeSnapshotOptions): Promise<string>;
    /**
     *
     * @param snapshotId
     */
...
export type DefaultImageSource =
    | "installation" // Source installation means the image comes from Devtool instance install config
...
export const createServiceMock = function <C extends DevtoolClient, S extends DevtoolServer>(
    methods: Partial<JsonRpcProxy<S>>,
): DevtoolServiceImpl<C, S> {
    return new DevtoolServiceImpl<C, S>(createServerMock(methods));
};

export const createServerMock = function <S extends DevtoolServer>(methods: Partial<JsonRpcProxy<S>>): JsonRpcProxy<S> {
...
export namespace DevtoolServer {
    ...
    export interface GenerateNewDevtoolTokenOptions {
        name?: string;
    ...
    export interface OnboardingState {
        /**
         * Whether this Devtool instance is already configured with SSO.
         */
...
export const DevtoolServerPath = "/devtool";

export const DevtoolServerProxy = Symbol("DevtoolServerProxy");
export type DevtoolServerProxy<S extends DevtoolServer> = JsonRpcProxy<S>;

export class DevtoolCompositeClient<Client extends DevtoolClient> implements DevtoolClient {
...
export type DevtoolService = DevtoolServiceImpl<DevtoolClient, DevtoolServer>;
...
export class WorkspaceInstanceUpdateListener {
    ...
    constructor(private readonly service: DevtoolService, private _info: WorkspaceInfo) {
...
export interface DevtoolServiceOptions {
    onReconnect?: () => void | Promise<void>;
}

export class DevtoolServiceImpl<Client extends DevtoolClient, Server extends DevtoolServer> {
    private readonly compositeClient = new DevtoolCompositeClient<Client>();

    constructor(public readonly server: JsonRpcProxy<Server>, private options?: DevtoolServiceOptions) {
