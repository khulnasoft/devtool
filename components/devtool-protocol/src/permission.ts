...
export namespace Permission {
    /** The permission to develop on this running Devtool installation */
    export const DEVELOPER: PermissionName = "developer";

    /** The permission for registry access (start workspaces referencing devtool-internal Docker images) */
...
export namespace Role {
    /** A role for people that are allowed to view Devtool internals */
