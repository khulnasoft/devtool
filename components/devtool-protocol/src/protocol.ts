...
export interface ProfileDetails {
    ...
    jobRoleOther?: string;
    // Reasons user is exploring Devtool when they signed up
...
export interface UserEnvVarValue extends EnvVarWithValue {
    id?: string;
    repositoryPattern: string; // DEPRECATED: Use ProjectEnvVar instead of repositoryPattern - https://github.com/devtool-com/devtool/issues/5322
}
...
export namespace UserEnvVar {
    ...
    /**
     * - DEVTOOL_IMAGE_AUTH is documented https://www.devtool.io/docs/configure/workspaces/workspace-image#use-a-private-docker-image
     */
    export const WhiteListFromReserved = ["DEVTOOL_IMAGE_AUTH"];
    ...
    export function validate(variable: UserEnvVarValue): string | undefined {
        ...
        if (!WhiteListFromReserved.includes(name) && name.startsWith("DEVTOOL_")) {
            return "Name with prefix 'DEVTOOL_' is reserved.";
        }
        if (name.trim() === "") {
...
export namespace WorkspaceImageBuild {
    export type Phase = "BaseImage" | "DevtoolLayer" | "Error" | "Done";
...
/**
 * WithDefaultConfig contexts disable the download of the devtool.yml from the repository
