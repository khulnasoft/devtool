...
import { DevtoolFileParser } from "./devtool-file-parser";
...
@suite
class TestDevtoolFileParser {
    protected parser: DevtoolFileParser;

    public before() {
        this.parser = new DevtoolFileParser();
    }
...
module.exports = new TestDevtoolFileParser(); // Only to circumvent no usage warning :-/
