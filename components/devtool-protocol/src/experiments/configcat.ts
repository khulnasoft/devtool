...
export const DEVTOOL_HOST = "devtool_host";

export class ConfigCatClient implements Client {
    constructor(private readonly client: IConfigCatClient, private readonly devtoolHost?: string) {}
...
export function attributesToUser(attributes: Attributes): ConfigCatUser {
    ...
    if (attributes.devtoolHost) {
        custom[DEVTOOL_HOST] = attributes.devtoolHost;
    }
