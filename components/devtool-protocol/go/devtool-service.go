...
type APIInterface interface {
	...
	GetDevtoolTokenScopes(ctx context.Context, tokenHash string) (res []string, err error)
	...
	GetDevtoolTokens(ctx context.Context) (res []*APIToken, err error)
	GenerateNewDevtoolToken(ctx context.Context, options *GenerateNewDevtoolTokenOptions) (res string, err error)
	DeleteDevtoolToken(ctx context.Context, tokenHash string) (err error)
...
const (
	...
	// FunctionGetDevtoolTokenScopes is the name of the GetDevtoolTokenScopes function
	FunctionGetDevtoolTokenScopes FunctionName = "getDevtoolTokenScopes"
	...
	// FunctionGetDevtoolTokens is the name of the getDevtoolTokens function
	FunctionGetDevtoolTokens FunctionName = "getDevtoolTokens"
	// FunctionGenerateNewDevtoolToken is the name of the generateNewDevtoolToken function
	FunctionGenerateNewDevtoolToken FunctionName = "generateNewDevtoolToken"
	// FunctionDeleteDevtoolToken is the name of the deleteDevtoolToken function
	FunctionDeleteDevtoolToken FunctionName = "deleteDevtoolToken"
...
var errNotConnected = errors.New("not connected to Devtool server")
...
// APIoverJSONRPC makes JSON RPC calls to the Devtool server is the APIoverJSONRPC message type
...
// GetDevtoolTokenScopes calls getDevtoolTokenScopes on the server
func (gp *APIoverJSONRPC) GetDevtoolTokenScopes(ctx context.Context, tokenHash string) (res []string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []string
	err = gp.C.Call(ctx, "getDevtoolTokenScopes", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GetDevtoolTokens calls getDevtoolTokens on the server
func (gp *APIoverJSONRPC) GetDevtoolTokens(ctx context.Context) (res []*APIToken, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []*APIToken
	err = gp.C.Call(ctx, "getDevtoolTokens", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GenerateNewDevtoolToken calls generateNewDevtoolToken on the server
func (gp *APIoverJSONRPC) GenerateNewDevtoolToken(ctx context.Context, options *GenerateNewDevtoolTokenOptions) (res string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result string
	err = gp.C.Call(ctx, "generateNewDevtoolToken", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// DeleteDevtoolToken calls deleteDevtoolToken on the server
func (gp *APIoverJSONRPC) DeleteDevtoolToken(ctx context.Context, tokenHash string) (err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	err = gp.C.Call(ctx, "deleteDevtoolToken", _params, nil)
	if err != nil {
		return
	}
...
type WorkspaceConfig struct {
	...
	// that is set by devtool at workspace creation time.
...
// GenerateNewDevtoolTokenOptions is the GenerateNewDevtoolTokenOptions message type
type GenerateNewDevtoolTokenOptions struct {
	Name string `json:"name,omitempty"`
...
type User struct {
	...
	// A map of random settings that alter the behaviour of Devtool on a per-user basis
