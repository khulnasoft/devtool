...
// DeleteDevtoolToken mocks base method.
func (m *MockAPIInterface) DeleteDevtoolToken(ctx context.Context, tokenHash string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteDevtoolToken", ctx, tokenHash)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteDevtoolToken indicates an expected call of DeleteDevtoolToken.
func (mr *MockAPIInterfaceMockRecorder) DeleteDevtoolToken(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteDevtoolToken", reflect.TypeOf((*MockAPIInterface)(nil).DeleteDevtoolToken), ctx, tokenHash)
}
...
// GenerateNewDevtoolToken mocks base method.
func (m *MockAPIInterface) GenerateNewDevtoolToken(ctx context.Context, options *GenerateNewDevtoolTokenOptions) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateNewDevtoolToken", ctx, options)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateNewDevtoolToken indicates an expected call of GenerateNewDevtoolToken.
func (mr *MockAPIInterfaceMockRecorder) GenerateNewDevtoolToken(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateNewDevtoolToken", reflect.TypeOf((*MockAPIInterface)(nil).GenerateNewDevtoolToken), ctx, options)
}
...
// GetDevtoolTokenScopes mocks base method.
func (m *MockAPIInterface) GetDevtoolTokenScopes(ctx context.Context, tokenHash string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDevtoolTokenScopes", ctx, tokenHash)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDevtoolTokenScopes indicates an expected call of GetDevtoolTokenScopes.
func (mr *MockAPIInterfaceMockRecorder) GetDevtoolTokenScopes(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDevtoolTokenScopes", reflect.TypeOf((*MockAPIInterface)(nil).GetDevtoolTokenScopes), ctx, tokenHash)
}

// GetDevtoolTokens mocks base method.
func (m *MockAPIInterface) GetDevtoolTokens(ctx context.Context) ([]*APIToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDevtoolTokens", ctx)
	ret0, _ := ret[0].([]*APIToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDevtoolTokens indicates an expected call of GetDevtoolTokens.
func (mr *MockAPIInterfaceMockRecorder) GetDevtoolTokens(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDevtoolTokens", reflect.TypeOf((*MockAPIInterface)(nil).GetDevtoolTokens), ctx)
}
