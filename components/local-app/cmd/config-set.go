...
Example:
  # Disable telemetry
  devtool config set --telemetry=false

  # Disable autoupdate
  devtool config set --autoupdate=false

  # Enable telemetry and autoupdate
  devtool config set --telemetry=true --autoupdate=true

  # Set your current context's organization
  devtool config set --organization-id=your-org-id
`,
