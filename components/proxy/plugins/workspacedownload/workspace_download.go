...
const (
	workspaceDownloadModule = "devtool.workspace_download"
)
...
// Download implements an HTTP handler that extracts devtool headers
...
func (Download) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.devtool_workspace_download",
