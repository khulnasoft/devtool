...
const (
	headlessLogDownloadModule = "devtool.headless_log_download"
)
...
// HeadlessLogDownload implements an HTTP handler that extracts devtool headers
...
func (HeadlessLogDownload) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.devtool_headless_log_download",
