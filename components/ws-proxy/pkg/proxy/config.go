...
type Config struct {
	...
	DevtoolInstallation *DevtoolInstallation `json:"devtoolInstallation"`
...
// DevtoolInstallation contains config regarding the Devtool installation.
type DevtoolInstallation struct {
...
// Validate validates the configuration to catch issues during startup and not at runtime.
func (c *DevtoolInstallation) Validate() error {
	if c == nil {
		return xerrors.Errorf("DevtoolInstallation not configured")
	}
