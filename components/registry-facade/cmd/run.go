...
import (
	...
	"github.com/khulnasoft/devtool/registry-facade/api/config"
	"github.com/khulnasoft/devtool/registry-facade/pkg/registry"
)
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		gpreg := prometheus.WrapRegistererWithPrefix("devtool_registry_facade_", promreg)
