...
const (
	...
	labelSkipNLayer = "skip-n.registry-facade.devtool.io"
)
...
const (
	envPrefixSet     = "DEVTOOL_ENV_SET_"
	envPrefixAppend  = "DEVTOOL_ENV_APPEND_"
	envPrefixPrepend = "DEVTOOL_ENV_PREPEND_"
)
