...
project(":") {
    kotlin {
        ...
        sourceSets["main"].kotlin.exclude("io/devtool/jetbrains/gateway/${excludedPackage}/**")
    }
...
intellijPlatform {
    ...
    publishing {
        ...
        var pluginChannels = providers.environmentVariable("JB_GATEWAY_DEVTOOL_PLUGIN_CHANNEL").getOrElse("")
...
tasks.register("installPlugin") {
    ...
    doLast {
        val pluginTargetPath = "distributions/jetbrains-gateway-devtool-plugin.zip"
