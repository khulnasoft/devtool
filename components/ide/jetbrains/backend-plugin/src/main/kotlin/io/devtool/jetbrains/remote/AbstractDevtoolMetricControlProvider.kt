...
abstract class AbstractDevtoolMetricControlProvider : MetricControlProvider {
    override val id: String = "devtoolMetricsControl"
    ...
    private fun createWorkspaceHeaderRow(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        ...
        val workspaceClassMetric = backendDiagnosticsService.getMetric("devtool_workspace_class")
    ...
    private fun createCpuControl(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        val cpuUsed = backendDiagnosticsService.getMetric("devtool_workspace_cpu_used")
        val cpuTotal = backendDiagnosticsService.getMetric("devtool_workspace_cpu_total")
        val cpuPercentage = backendDiagnosticsService.getMetric("devtool_workspace_cpu_percentage")
    ...
    private fun createMemoryControl(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        val memoryUsed = backendDiagnosticsService.getMetric("devtool_workspace_memory_used")
        val memoryTotal = backendDiagnosticsService.getMetric("devtool_workspace_memory_total")
        val memoryPercentage = backendDiagnosticsService.getMetric("devtool_workspace_memory_percentage")
