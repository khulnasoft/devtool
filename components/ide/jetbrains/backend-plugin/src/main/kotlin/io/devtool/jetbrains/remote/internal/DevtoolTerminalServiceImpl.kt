...
import io.devtool.jetbrains.remote.AbstractDevtoolTerminalService
...
class DevtoolTerminalServiceImpl(val project: Project) : AbstractDevtoolTerminalService(project) {
