...
import (
	...
	"github.com/khulnasoft/devtool/components/devtool-db/go/dbtest"
	...
	}{
		{
			...
			Claims: jwt.MapClaims{
				...
				"groups_direct": []string{
					"devtool-team",
					"devtool-team2/sub_group",
				},
				"email":          "test@devtool.io",
				"email_verified": false,
			},
			CEL: "claims.email_verified && claims.email_verified.email.endsWith('@devtool.io')",
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@devtool.io')) || 'devtool-team' in claims.groups_direct",
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@devtool.io')) || 'devtool-team2' in claims.groups_direct",
		},
		{
