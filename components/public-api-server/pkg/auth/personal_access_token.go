...
const PersonalAccessTokenPrefix = "devtool_pat_"
...
// The PersonalAccessToken, in string form, takes the following shape: devtool_pat_<signature>.<value>
// E.g. devtool_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
...
func ParsePersonalAccessToken(token string, signer Signer) (PersonalAccessToken, error) {
	...
	// Assume we start with the following token: devtool_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
	...
	// Remove the devtool_pat_ prefix
