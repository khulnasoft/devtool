...
import (
	...
	"github.com/khulnasoft/devtool/public-api-server/middleware"
	"github.com/khulnasoft/devtool/public-api-server/pkg/apiv1"
	"github.com/khulnasoft/devtool/public-api-server/pkg/auth"
	"github.com/khulnasoft/devtool/public-api-server/pkg/billingservice"
	"github.com/khulnasoft/devtool/public-api-server/pkg/identityprovider"
	"github.com/khulnasoft/devtool/public-api-server/pkg/jws"
	"github.com/khulnasoft/devtool/public-api-server/pkg/oidc"
	"github.com/khulnasoft/devtool/public-api-server/pkg/origin"
	"github.com/khulnasoft/devtool/public-api-server/pkg/proxy"
	"github.com/khulnasoft/devtool/public-api-server/pkg/webhooks"
...
func Start(logger *logrus.Entry, version string, cfg *config.Configuration) error {
	...
	devtoolAPI, err := url.Parse(cfg.DevtoolServiceURL)
	if err != nil {
		return fmt.Errorf("failed to parse Devtool API URL: %w", err)
	}

	connPool, err := proxy.NewConnectionPool(devtoolAPI, 500)
	if err != nil {
