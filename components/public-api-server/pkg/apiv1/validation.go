...
func parseDevtoolTimeStampOrDefault(s string) *timestamppb.Timestamp {
	parsed, err := parseDevtoolTimestamp(s)
	if err != nil {
...
func parseDevtoolTimestamp(input string) (*timestamppb.Timestamp, error) {
