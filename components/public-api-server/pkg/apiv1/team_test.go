	...
	members := []*protocol.TeamMemberInfo{
		{
			...
			FullName:     "First Last",
			PrimaryEmail: "email1@devtool.io",
		...
		},
		{
			...
			PrimaryEmail: "email2@devtool.io",
		...
		Members: []*v1.TeamMember{
			{
				...
				MemberSince:  parseDevtoolTimeStampOrDefault(members[0].MemberSince),
			...
			},
			{
				...
				MemberSince:  parseDevtoolTimeStampOrDefault(members[1].MemberSince),
