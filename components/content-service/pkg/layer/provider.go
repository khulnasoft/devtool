...
import (
	...
	"github.com/khulnasoft/devtool/content-service/api/config"
	"github.com/khulnasoft/devtool/content-service/pkg/executor"
	"github.com/khulnasoft/devtool/content-service/pkg/initializer"
...
func contentDescriptorToLayer(cdesc []byte) (*Layer, error) {
	return layerFromContent(
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace/.devtool", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeReg, Name: "/workspace/.devtool/content.json", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755, Size: int64(len(cdesc))}, cdesc},
	)
}
...
func workspaceReadyLayer(src csapi.WorkspaceInitSource) (*Layer, error) {
	...
	return layerFromContent(
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace/.devtool", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeReg, Name: "/workspace/.devtool/ready", Uid: initializer.DevtoolUID, Gid: initializer.DevtoolGID, Mode: 0755, Size: int64(len(ctnt))}, []byte(ctnt)},
	)
}
