...
type WorkspaceInfoResponse struct {
	...
	DevtoolApi *WorkspaceInfoResponse_DevtoolAPI `protobuf:"bytes,7,opt,name=devtool_api,json=devtoolApi,proto3" json:"devtool_api,omitempty"`
	// devtool_host provides Devtool host URL.
	DevtoolHost string `protobuf:"bytes,8,opt,name=devtool_host,json=devtoolHost,proto3" json:"devtool_host,omitempty"`
...
func (x *WorkspaceInfoResponse) GetDevtoolApi() *WorkspaceInfoResponse_DevtoolAPI {
	if x != nil {
		return x.DevtoolApi
	}
	return nil
...
func (x *WorkspaceInfoResponse) GetDevtoolHost() string {
	if x != nil {
		return x.DevtoolHost
	}
	return ""
}
...
type WorkspaceInfoResponse_DevtoolAPI struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceInfoResponse_DevtoolAPI) Reset() {
	*x = WorkspaceInfoResponse_DevtoolAPI{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceInfoResponse_DevtoolAPI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceInfoResponse_DevtoolAPI) ProtoMessage() {}

func (x *WorkspaceInfoResponse_DevtoolAPI) ProtoReflect() protoreflect.Message {
	mi := &file_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceInfoResponse_DevtoolAPI.ProtoReflect.Descriptor instead.
func (*WorkspaceInfoResponse_DevtoolAPI) Descriptor() ([]byte, []int) {
	return file_info_proto_rawDescGZIP(), []int{1, 0}
}

func (x *WorkspaceInfoResponse_DevtoolAPI) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *WorkspaceInfoResponse_DevtoolAPI) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
var file_info_proto_goTypes = []interface{}{
	...
	(*WorkspaceInfoResponse_DevtoolAPI)(nil),      // 3: supervisor.WorkspaceInfoResponse.DevtoolAPI
...
var file_info_proto_depIdxs = []int32{
	3, // 0: supervisor.WorkspaceInfoResponse.devtool_api:type_name -> supervisor.WorkspaceInfoResponse.DevtoolAPI
...
func file_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceInfoResponse_DevtoolAPI); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
