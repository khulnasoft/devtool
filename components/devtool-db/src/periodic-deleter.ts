...
import { DevtoolTableDescriptionProvider, TableDescription } from "./tables";
import { TypeORM } from "./typeorm/typeorm";

@injectable()
export class PeriodicDbDeleter {
    @inject(DevtoolTableDescriptionProvider) protected readonly tableProvider: DevtoolTableDescriptionProvider;
