...
import (
	...
	db "github.com/khulnasoft/devtool/components/devtool-db/go"
...
func NewWorkspace(t *testing.T, workspace db.Workspace) db.Workspace {
	...
	contextURL := "https://github.com/khulnasoft/devtool"
