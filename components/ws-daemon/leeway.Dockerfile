...
# Add devtool user for operations (e.g. checkout because of the post-checkout hook!)
RUN groupadd -r -g 33333 devtool \
  && useradd -r -u 33333 -md /home/devtool -s /bin/bash -g devtool devtool \
  && usermod -a -G devtool devtool
...
COPY default.gitconfig /home/devtool/.gitconfig
