...
//+kubebuilder:rbac:groups=workspace.devtool.io,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=workspace.devtool.io,resources=snapshots/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=workspace.devtool.io,resources=snapshots/finalizers,verbs=update
