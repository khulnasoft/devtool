module github.com/khulnasoft/devtool/ws-daemon/nsinsider

go 1.22

replace github.com/seccomp/libseccomp-golang => github.com/khulnasoft/libseccomp-golang v0.9.2-0.20220203100026-45179215fdb1 // leeway indirect from components/workspacekit:lib
