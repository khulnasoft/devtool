...
// NewFromEnvironment creates a new error report instance based on the DEVTOOL_ENABLED_ERROR_REPORTING
// environment variable. This function never returns nil
func NewFromEnvironment() ErrorReporter {
	isEnabled := os.Getenv("DEVTOOL_ENABLED_ERROR_REPORTING") == "true"
	if !isEnabled {
