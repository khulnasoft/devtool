...
proto.wsman.WorkspaceMetadata.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(7, f, proto.wsman.WorkspaceMetadata.Metrics.serializeBinaryToWriter);
    }
};
...
proto.wsman.WorkspaceMetadata.Metrics.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getImage();
    if (f != null) {
        writer.writeMessage(1, f, proto.wsman.WorkspaceMetadata.ImageInfo.serializeBinaryToWriter);
    }
};
