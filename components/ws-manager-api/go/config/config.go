...
import (
	...
	cntntcfg "github.com/khulnasoft/devtool/content-service/api/config"
)
...
type Configuration struct {
	...
	// - `Host` which is the DevtoolHostURL
	...
	// Is the URL under which Devtool is installed (e.g. https://devtool.io)
	DevtoolHostURL string `json:"hostURL"`
	...
	// Cluster host under which workspaces are served, e.g. ws-eu11.devtool.io
...
func (c *Configuration) Validate() error {
	...
	err = ozzo.ValidateStruct(c,
		...
		ozzo.Field(&c.DevtoolHostURL, ozzo.Required, is.URL),
...
var validWorkspaceURLTemplate = ozzo.By(func(o interface{}) error {
	...
	wsurl, err := RenderWorkspaceURL(s, "foo", "bar", "devtool.io")
	if err != nil {
