...
import { PrebuiltWorkspace, User, UserEnvVar, Workspace, WorkspaceType } from "@khulnasoft/devtool-protocol/lib/protocol";
import {
    OrgMemberInfo,
    Organization,
    TeamMemberInfo,
    ...
    public async workspaceLikeResourceGuardsCanAcccess() {
        ...
        const createInstance = (): WorkspaceInstance => {
            return {
                ...
                region: "local",
                configuration: {
                    ideImage: "devtool/workspace-full:latest",
                },
                status: {
                    version: 1,
                    conditions: {},
                ...
                workspaceImage: "devtool/workspace-full:latest",
            };
        };
        const createPrebuild = (): PrebuiltWorkspace => {
            return {
                ...
                cloneURL: "https://github.com/khulnasoft/devtool",
                commit: "sha123123213",
                creationTime: new Date(2000, 1, 2).toISOString(),
                state: "available",
                statusVersion: 1,
