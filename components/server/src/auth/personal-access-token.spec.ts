...
describe("PersonalAccessToken", () => {
    it("should parse token successfully", () => {
        const token = "devtool_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4." + "test".repeat(10);
    ...
    it("should parse token and throw an error", () => {
        const tokens = [
            "devtool_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4.", // no value
            `devtool_pat_.${"test".repeat(10)}`, // no signature
