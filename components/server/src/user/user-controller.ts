...
export class UserController {
    ...
    get apiRouter(): express.Router {
        ...
        router.get(
            ...
            loginUserWithOts(async (req: express.Request, res: express.Response, user: User, secret: string) => {
                // This mechanism is used by integration tests, cmp. https://github.com/khulnasoft/devtool/blob/478a75e744a642d9b764de37cfae655bc8b29dd5/test/tests/ide/vscode/python_ws_test.go#L105
        ...
        router.post(
            ...
            async (req: express.Request, res: express.Response, next: express.NextFunction) => {
                ...
                await runWithSubjectId(SubjectId.fromUserId(user.id), async () => {
                    ...
                    const server = this.createDevtoolServer(user, resourceGuard);
                    try {
    ...
    protected async augmentLoginRequest(req: express.Request) {
        ...
        if (returnToURL) {
            // returnToURL -> https://devtool.io/#https://github.com/theia-ide/theia"
    ...
    protected getSafeReturnToParam(req: express.Request) {
        ...
        if (
            ...
            this.urlStartsWith(returnToURL, "https://www.devtool.io")
        ) {
            return returnToURL;
        }
    ...
    private createDevtoolServer(user: User, resourceGuard: ResourceAccessGuard) {
