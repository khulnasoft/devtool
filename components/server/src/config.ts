...
import { NamedWorkspaceFeatureFlag } from "@khulnasoft/devtool-protocol";
...
export interface ConfigSerialized {
    ...
    /**
     * If a numeric value interpreted as days is set, repositories not beeing opened with Devtool are
     * considered inactive.
     */
    inactivityPeriodForReposInDays?: number;
...
export namespace ConfigFile {
    ...
    function loadAndCompleteConfig(config: ConfigSerialized): Config {
        const hostUrl = new DevtoolHostUrl(config.hostUrl);
