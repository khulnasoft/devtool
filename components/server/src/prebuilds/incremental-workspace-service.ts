...
import { PrebuiltWorkspaceState, WithCommitHistory } from "@devtool/devtool-protocol/lib/protocol";
...
export class IncrementalWorkspaceService {
    ...
    public async findBaseForIncrementalWorkspace(
        ...
        const [recentPrebuilds, imageSource] = await Promise.allSettled([
            ...
            // (e.g., at the time of writing, the Devtool repository has 16K+ prebuilds, but only ~300 not-garbage-collected)
