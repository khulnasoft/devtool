...
export namespace DevData {
            ...
            identities: [
                {
                    ...
                    primaryEmail: "somefox@devtool.io",
                },
                {
                    authId: "3171928",
                    authName: "somefox",
    ...
    export function createGitHubTestToken(): Token {
        if (!process.env.DEVTOOL_TEST_TOKEN_GITHUB) {
            console.error(
                `DEVTOOL_TEST_TOKEN_GITHUB env var is not set\n\n\t export DEVTOOL_TEST_TOKEN_GITHUB='{"username": "devtool-test", "value": $GITHUB_TOKEN}'`,
            );
        }
        return {
            ...getTokenFromEnv("DEVTOOL_TEST_TOKEN_GITHUB"),
    ...
    export function createGitlabTestToken(): Token {
        return {
            ...getTokenFromEnv("DEVTOOL_TEST_TOKEN_GITLAB"),
    ...
    export function createAzureDevOpsTestToken(): Token {
        return {
            ...getTokenFromEnv("DEVTOOL_TEST_TOKEN_AZURE_DEVOPS"),
    ...
    export function createBitbucketTestToken(): Token {
        const result = {
            ...getTokenFromEnv("DEVTOOL_TEST_TOKEN_BITBUCKET"),
            scopes: [],
        };
        return result;
    }
...
export namespace DevTestHelper {
    export const AzureTestEnv = "DEVTOOL_TEST_TOKEN_AZURE_DEVOPS";
