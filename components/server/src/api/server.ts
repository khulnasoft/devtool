...
import { TeamsService as TeamsServiceDefinition } from "@devtool/public-api/lib/devtool/experimental/v1/teams_connect";
...
import { AuditLogService as AuditLogServiceFromAPI } from "@devtool/public-api/lib/devtool/v1/auditlogs_connect";
...
import { TokenService } from "@devtool/public-api/lib/devtool/v1/token_connect";
                ...
                return (...args: any[]) => {
                    ...
                    const handleError = (reason: unknown) => {
                        ...
                        if (
                            ...
                            // Compare https://linear.app/devtool/issue/ENT-232 and https://github.com/khulnasoft/devtool/pull/19827
                    ...
                    if (grpc_type === "unary" || grpc_type === "client_stream") {
                        return withRequestContext(async () => {
                            ...
                            if (
                                isCellDisabled &&
                                requestContext.requestMethod === "devtool.v1.UserService/getAuthenticatedUser"
                            ) {
