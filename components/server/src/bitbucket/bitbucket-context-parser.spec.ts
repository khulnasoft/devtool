...
class TestBitbucketContextParser {
    ...
    @test public testCanHandleBitbucketRepo() {
        expect(this.parser.canHandle(this.user, "https://bitbucket.org/devtool/integration-tests/src/master/")).to.be
            .true;
    }
    ...
    @test public async testShortContext_01() {
        const result = await this.parser.handle({}, this.user, "https://bitbucket.org/devtool/integration-tests");
        expect(result).to.deep.include({
            ...
            repository: {
                ...
                cloneUrl: "https://bitbucket.org/devtool/integration-tests.git",
                defaultBranch: "master",
                private: false,
            },
            title: "devtool/integration-tests - master",
        });
    }
    ...
    @test public async testSrcContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
    ...
    @test public async testSrcContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/8fcf6c869d0cdb570bb6f2f9aa5f8ed72c9d953a/?at=Devtool%2Ftesttxt-created-online-with-bitbucket-1589277871983",
        );
        expect(result).to.deep.include({
            ref: "Devtool/testtxt-created-online-with-bitbucket-1589277871983",
            refType: "branch",
            path: "",
            ...
            title: "devtool/integration-tests - Devtool/testtxt-created-online-with-bitbucket-1589277871983",
        });
    }
    ...
    @test public async testSrcContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/second-branch/",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
            ...
            title: "devtool/integration-tests - second-branch",
        });
    }
    ...
    @test public async testCommitsContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/commits/branch/second-branch",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
    ...
    @test public async testBranchContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/branch/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
    ...
    @test public async testBranchContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/branch/second-branch",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
    ...
    @test public async testBranchContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/branch/feature/JIRA-123-summary",
        );
        expect(result).to.deep.include({
            ...
            title: "devtool/integration-tests - feature/JIRA-123-summary",
        });
    }
    ...
    @test public async testCommitsContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/commits/tag/first-tag",
        );
        expect(result).to.deep.include({
            ref: "first-tag",
            refType: "tag",
            ...
            title: "devtool/integration-tests - first-tag",
        });
    }
    ...
    @test public async testSrcContext_04() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/first-tag/",
        );
        expect(result).to.deep.include({
            ref: "first-tag",
            refType: "tag",
    ...
    @test public async testCommitsContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/commits/5a24a0c8a7b42c2e6418593d788e17cb987bda25",
        );
        expect(result).to.deep.include({
            ref: "",
            refType: "revision",
            ...
            title: "devtool/integration-tests - 5a24a0c8a7b42c2e6418593d788e17cb987bda25",
        });
    }
    ...
    @test public async testFileContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/master/README.md",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
            ...
            title: "devtool/integration-tests - master:README.md",
        });
    }
    ...
    @test public async testFileContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/branch-with-dir/my-dir/test.txt",
        );
        expect(result).to.deep.include({
            ref: "branch-with-dir",
            refType: "branch",
            ...
            title: "devtool/integration-tests - branch-with-dir:my-dir/test.txt",
        });
    }
    ...
    @test public async testDirectoryContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/src/branch-with-dir/my-dir/",
        );
        expect(result).to.deep.include({
            ref: "branch-with-dir",
            refType: "branch",
            ...
            title: "devtool/integration-tests - branch-with-dir:my-dir",
        });
    }
    ...
    @test public async testPullRequestContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/pull-requests/1/readme-updated/diff",
        );
        expect(result).to.deep.include({
    ...
    @test public async testPullRequestContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/pull-requests/3/say-hello-to-devtool/diff",
        );
        expect(result).to.deep.include({
            title: "Say Hello to Devtool",
            repository: {
                host: "bitbucket.org",
                owner: "corneliusltf",
    ...
    @test public async testIssueContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests/issues/1/first-issue",
        );
        expect(result).to.deep.include({
            title: "First issue",
            repository: {
    ...
    @test public async testSrcContextForkedRepo_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devtool/integration-tests-forked-repository/src/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
            ...
            repository: {
                ...
                cloneUrl: "https://bitbucket.org/devtool/integration-tests-forked-repository.git",
                defaultBranch: "master",
                private: false,
                fork: {
                    parent: {
            ...
            title: "devtool/integration-tests-forked-repository - master",
        });
    }
}
