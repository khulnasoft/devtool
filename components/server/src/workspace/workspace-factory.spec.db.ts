...
export class MockImageSourceProvider extends ImageSourceProvider {
    public imageSource: WorkspaceImageSource = { baseImageResolved: "devtool/workspace-full:latest" };
...
describe("WorkspaceFactory", async () => {
    ...
    it("createForPrebuiltWorkspace_noPrebuild", async () => {
        ...
        const contextURL = "https://github.com/khulnasoft/devtool/tree/gpl/test";
