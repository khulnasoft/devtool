...
export class WorkspaceService {
    ...
    async getWorkspaces(userId: string, options: DevtoolServer.GetWorkspacesOptions): Promise<WorkspaceInfo[]> {
    ...
    public async sendHeartBeat(
        userId: string,
        options: DevtoolServer.SendHeartBeatOptions,
        check: (instance: WorkspaceInstance, workspace: Workspace) => Promise<void> = async () => {},
    ): Promise<void> {
    ...
    public async validateImageRef(ctx: TraceContext, user: User, imageRef: string) {
        try {
            ...
            // see https://github.com/khulnasoft/devtool/blob/f3e41f8d86234e4101edff2199c54f50f8cbb656/components/image-builder-mk3/pkg/orchestrator/orchestrator.go#L561
    ...
    public async takeSnapshot(userId: string, options: DevtoolServer.TakeSnapshotOptions): Promise<Snapshot> {
