...
export const productionContainerModule = new ContainerModule(
    (bind, unbind, isBound, rebind, unbindAsync, onActivation, onDeactivation) => {
        ...
        bind(DevtoolTokenService).toSelf().inSingletonScope();
        ...
        bind(DevtoolFileParser).toSelf().inSingletonScope();
        ...
        bind(ServerFactory).toAutoFactory(DevtoolServerImpl);
        ...
        bind(DevtoolServerImpl).toSelf();
        bind(WebsocketConnectionManager)
            .toDynamicValue((ctx) => {
                const serverFactory = () => ctx.container.get<DevtoolServerImpl>(DevtoolServerImpl);
