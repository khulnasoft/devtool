...
@suite(timeout(10000), retries(2), skip(ifEnvVarNotSet("DEVTOOL_TEST_TOKEN_GITHUB")))
class TestGithubContextParser {
    ...
    @test public async testTreeContext_04() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/blob/nametest/src/src/server.ts",
        );
        expect(result).to.deep.include({
            ref: "nametest/src",
            refType: "branch",
            ...
            repository: {
                ...
                cloneUrl: "https://github.com/khulnasoft/devtool-test-repo.git",
                defaultBranch: "1test",
                private: false,
            },
            title: "khulnasoft/devtool-test-repo - nametest/src",
        });
    }
    ...
    @test public async testTreeContext_05() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/tree/499efbbcb50e7e6e5e2883053f72a34cd5396be3/folder1/folder2",
        );
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - 499efbbc:folder1/folder2",
            repository: {
                host: "github.com",
                owner: "khulnasoft",
                name: "devtool-test-repo",
    ...
    @test public async testReleasesContext_tag_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool/releases/tag/v0.9.0",
        );
        expect(result).to.deep.include({
            ref: "v0.9.0",
            refType: "tag",
            isFile: false,
            path: "",
            title: "khulnasoft/devtool - v0.9.0",
            revision: "25ece59c495d525614f28971d41d5708a31bf1e3",
            repository: {
                cloneUrl: "https://github.com/khulnasoft/devtool.git",
                defaultBranch: "main",
                host: "github.com",
                name: "devtool",
                owner: "khulnasoft",
    ...
    @test public async testCommitsContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/commits/4test",
        );
        expect(result).to.deep.include({
            ref: "4test",
            refType: "branch",
            ...
            title: "khulnasoft/devtool-test-repo - 4test",
        });
    }
    ...
    @test public async testCommitContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/commit/409ac2de49a53d679989d438735f78204f441634",
        );
        expect(result).to.deep.include({
            ref: "",
            refType: "revision",
            ...
            title: "khulnasoft/devtool-test-repo - Test 3",
        });
    }
    ...
    @test public async testCommitContext_02_notExistingCommit() {
        try {
            await this.parser.handle(
                {},
                this.user,
                "https://github.com/khulnasoft/devtool-test-repo/commit/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
            );
    ...
    @test public async testCommitContext_02_invalidSha() {
        try {
            await this.parser.handle({}, this.user, "https://github.com/khulnasoft/devtool-test-repo/commit/invalid");
            // ensure that an error has been thrown
            chai.assert.fail();
        } catch (e) {
    ...
    @test public async testIssueContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/issues/42",
        );
        expect(result).to.deep.include({
    ...
    @test public async testIssuePageContext() {
        const result = await this.parser.handle({}, this.user, "https://github.com/khulnasoft/devtool-test-repo/issues");
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - 1test",
            repository: {
                host: "github.com",
                owner: "khulnasoft",
                name: "devtool-test-repo",
    ...
    @test public async testIssueThroughPullRequestContext() {
        const result = await this.parser.handle({}, this.user, "https://github.com/khulnasoft/devtool-test-repo/pull/42");
        expect(result).to.deep.include({
            title: "Test issue web-extension",
            repository: {
                host: "github.com",
    ...
    @test public async testBlobContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/blob/aba298d5084a817cdde3dd1f26692bc2a216e2b9/test-comment-01.md",
        );
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - aba298d5:test-comment-01.md",
            repository: {
                host: "github.com",
                owner: "khulnasoft",
                name: "devtool-test-repo",
    ...
    @test public async testBlobContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/blob/499efbbcb50e7e6e5e2883053f72a34cd5396be3/folder1/folder2/content2",
        );
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - 499efbbc:folder1/folder2/content2",
            repository: {
                host: "github.com",
                owner: "khulnasoft",
                name: "devtool-test-repo",
    ...
    @test public async testBlobContextShort_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/blob/499efbbc/folder1/folder2/content2",
        );
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - 499efbbc:folder1/folder2/content2",
            repository: {
    ...
    @test public async testBlobContextShort_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://github.com/khulnasoft/devtool-test-repo/blob/499ef/folder1/folder2/content2",
        );
        expect(result).to.deep.include({
            title: "khulnasoft/devtool-test-repo - 499efbbc:folder1/folder2/content2",
            repository: {
