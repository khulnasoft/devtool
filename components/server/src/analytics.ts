...
import { IAnalyticsWriter, IdentifyMessage, PageMessage, TrackMessage } from "@khulnasoft/devtool-protocol/lib/analytics";
...
export async function trackSignup(user: User, request: Request, analytics: IAnalyticsWriter) {
    ...
    analytics.track({
        ...
        properties: {
            ...
            qualified: !!request.cookies["devtool-marketing-website-visited"],
