...
import (
	...
	"github.com/khulnasoft/devtool/image-builder/pkg/resolve"
...
func TestStandaloneRefResolverResolve(t *testing.T) {
	...
	tests := []struct {
		...
		{
			Name: "with-port",
			Ref:  "some-internal-registry.customer.com:5000/devtool/base-image:latest",
			ResolveResponse: ResolveResponse{
				MF: &ociv1.Manifest{Config: ociv1.Descriptor{Size: 1}},
			},
			Expectation: Expectation{
				Ref: "some-internal-registry.customer.com:5000/devtool/base-image@sha256:25d33b2d291ce47c3e4059589766ed98fadab639577efe5e9c89e4a4b50888fc",
			},
		},
		{
		...
		{
			Name: "not authorized",
			Ref:  "registry-1.testing.devtool-self-hosted.com:5000/devtool/devtool/workspace-full:latest",
			ResolveResponse: ResolveResponse{
		...
		},
		{
			...
			Ref:  "registry-1.docker.io:5000/devtool/devtool/workspace-full:latest-pulled-too-often",
			ResolveResponse: ResolveResponse{
				Error: errors.New("httpReadSeeker: failed open: unexpected status code https://registry-1.docker.io/v2/devtool/workspace-full/manifests/sha256:279f925ad6395f11f6b60e63d7efa5c0b26a853c6052327efbe29bbcc0bafd6a: 429 Too Many Requests - Server message: toomanyrequests: You have reached your pull rate limit. You may increase the limit by authenticating and upgrading: https://www.docker.com/increase-rate-limit"),
			},
			Expectation: Expectation{
