...
import { GetOnboardingStateRequest } from "@khulnasoft/public-api/lib/devtool/v1/installation_pb";
...
// TODO: This is a temporary safety-guard against this flow showing up on devtool.io
...
export const isCurrentHostExcludedFromSetup = () => {
    // Purposely not using isDevtoolIo() check here to avoid disabling on preview environments too.
    return ["devtool.io", "devtool-staging.com"].includes(window.location.hostname);
};
