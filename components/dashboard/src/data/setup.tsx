...
export const setupQueryClientProvider = () => {
    ...
    const DevtoolQueryClientProvider: FunctionComponent = ({ children }) => {
        return (
    ...
    return DevtoolQueryClientProvider;
};

// Persister that uses IndexedDB
export function createIDBPersister(idbValidKey: IDBValidKey = "devtoolQueryClient"): Persister {
