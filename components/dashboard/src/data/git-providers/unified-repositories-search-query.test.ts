...
test("should perform weak validation for git URLs", () => {
    ...
    expect(isValidGitUrl("https://github.com/khulnasoft/devtool/pull/20281")).toEqual(true);
    expect(isValidGitUrl("https://gitlab.com/filiptronicek/devtool.git")).toEqual(true);
    expect(isValidGitUrl("git@github.com:khulnasoft/devtool.git")).toEqual(true);
    expect(isValidGitUrl("git@gitlab.com:filiptronicek/devtool.git")).toEqual(true);
    expect(isValidGitUrl("ssh://login@server.com:12345/~/repository.git")).toBe(true);
    expect(isValidGitUrl("https://bitbucket.devtool-dev.com/scm/~geropl/test-user-repo.git")).toBe(true);
    expect(isValidGitUrl("git://gitlab.com/devtool/spring-petclinic")).toBe(true);
