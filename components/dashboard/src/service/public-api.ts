...
import { Project as ProtocolProject } from "@khulnasoft/devtool-protocol/lib/teams-projects-protocol";
import { HelloService } from "@khulnasoft/public-api/lib/devtool/experimental/v1/dummy_connect";
import { OIDCService } from "@khulnasoft/public-api/lib/devtool/experimental/v1/oidc_connect";
import { ProjectsService } from "@khulnasoft/public-api/lib/devtool/experimental/v1/projects_connect";
import { Project } from "@khulnasoft/public-api/lib/devtool/experimental/v1/projects_pb";
import { TokensService } from "@khulnasoft/public-api/lib/devtool/experimental/v1/tokens_connect";
...
import { ConfigurationService } from "@khulnasoft/public-api/lib/devtool/v1/configuration_connect";
import { PrebuildService } from "@khulnasoft/public-api/lib/devtool/v1/prebuild_connect";
import { getMetricsInterceptor } from "@khulnasoft/devtool-protocol/lib/metrics";
...
import { Prebuild, WatchPrebuildRequest, WatchPrebuildResponse } from "@khulnasoft/public-api/lib/devtool/v1/prebuild_pb";
...
import { SCMService } from "@khulnasoft/public-api/lib/devtool/v1/scm_connect";
...
import { InstallationService } from "@khulnasoft/public-api/lib/devtool/v1/installation_connect";
                ...
                const resolvedFlags = await Promise.all(
                    featureFlags.map((ff) =>
                        experimentsClient.getValueAsync(ff, false, {
                            user,
                            devtoolHost: window.location.host,
                        }),
                    ),
                );
