...
const installationOptions: BrowserOption[] = [
    {
        type: "firefox",
        aliases: ["firefox"],
        url: "https://addons.mozilla.org/en-US/firefox/addon/devtool/",
    },
    {
        type: "chromium",
        aliases: ["chrome", "edge", "brave", "chromium", "vivaldi", "opera"],
        url: "https://chrome.google.com/webstore/detail/devtool-always-ready-to-co/dodmmooeoklaejobgleioelladacbeki",
    },
];
    ...
    return (
        <section className="flex justify-center mt-24 mx-4">
            <div className="sm:flex justify-between border-pk-border-light border-2 rounded-xl hidden max-w-xl mt-4">
                ...
                <img
                    alt="A button that says Devtool"
