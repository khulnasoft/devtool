...
import { hoursBefore, isDateSmallerOrEqual } from "@khulnasoft/devtool-protocol/lib/util/timeutil";
...
import { ReactComponent as DevtoolStrokedSVG } from "../icons/devtool-stroked.svg";
        ...
        <>
            ...
            {!isLoading &&
                (activeWorkspaces.length > 0 || inactiveWorkspaces.length > 0 || searchTerm ? (
                    <>
                        <div className={isDevtoolIo() ? "!pl-0 app-container flex flex-1 flex-row" : "app-container"}>
                            <div>
                                <WorkspacesSearchBar
                                    limit={limit}
                                ...
                                />
                                <ItemsList className={isDevtoolIo() ? "app-container xl:!pr-4 pb-40" : ""}>
                                                ...
                                                <div className="flex flex-grow flex-col ">
                                                    ...
                                                    <div className="text-sm flex-auto">
                                                        ...
                                                        <a
                                                            ...
                                                            rel="noreferrer"
                                                            className="gp-link"
                                                            href="https://www.devtool.io/docs/configure/workspaces/workspace-lifecycle#workspace-deletion"
                            ...
                            {/* Show Educational if user is in devtoolIo */}
                            {isDevtoolIo() && (
                                <div className="max-xl:hidden border-l border-gray-200 dark:border-gray-800 pl-6 pt-5 pb-4 space-y-8">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex flex-col gap-1 w-fit">
                                            <a
                                                href="https://www.devtool.io/docs/introduction"
                                                target="_blank"
                                            ...
                                            <a
                                                href="https://www.devtool.io/docs/configure/workspaces"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-sm text-pk-content-primary items-center gap-x-2 flex flex-row"
                                            >
                                            ...
                                            <a
                                                href="https://www.devtool.io/docs/references/devtool-yml"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-sm text-pk-content-primary items-center gap-x-2 flex flex-row"
                                            >
