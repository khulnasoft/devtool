...
const banners = [
    {
        ...
        title: "Beyond Kubernetes: A deep-dive into Devtool Flex with our CTO",
        link: "https://www.devtool.io/events#watch-on-demand",
    },
    {
        type: "Blog Post",
        title: "Devtool Enterprise:<br/> Self-hosted, not self-managed",
        link: "https://www.devtool.io/blog/self-hosted-not-self-managed",
    },
    {
        type: "Customer Story",
        title: "Thousands of hours spent on VM-based development environments reduced to zero using Devtool",
        link: "https://www.devtool.io/customers/kingland",
    },
    {
        type: "Gartner Report",
        title: `"By 2026, 60% of cloud workloads will be built and deployed using CDE's"`,
        link: "https://www.devtool.io/blog/gartner-2023-cde-hypecycle",
    },
];
