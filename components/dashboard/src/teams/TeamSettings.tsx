...
export default function TeamSettingsPage() {
    ...
    const deleteTeam = useCallback(async () => {
        ...
        invalidateOrgs();
        document.location.href = devtoolHostUrl.asDashboard().toString();
        ...
        >
            ...
            <ModalBody>
                ...
                <div className="mt-4">
                    <TextInputField
                        label="Default Image"
                        hint="Use any official or custom workspace image from Docker Hub or any private container registry that the Devtool instance can access."
