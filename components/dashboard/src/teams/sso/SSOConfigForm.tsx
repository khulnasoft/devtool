...
export const SSOConfigForm: FC<Props> = ({ config, readOnly = false, onChange }) => {
    const redirectUrl = devtoolHostUrl.with({ pathname: `/iam/oidc/callback` }).toString();
    ...
    return (
        <>
            ...
            <Subheading className="mt-8">
                ...
                <a
                    href="https://www.devtool.io/docs/enterprise/setup-devtool/configure-sso#restrict-available-accounts-in-your-identity-providers"
                    target="_blank"
