...
import { WorkspaceTimeoutDuration } from "@khulnasoft/devtool-protocol";
        ...
        <>
            <OrgSettingsPage>
                <div className="space-y-8">
                    ...
                    {isDevtoolIo() && <WorkspaceClassesEnterpriseCallout />}
        ...
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <div className="mt-6 flex flex-row space-x-2">
                <LinkButton
                    ...
                    href="https://www.devtool.io/docs/configure/workspaces/workspace-classes#enterprise"
                    isExternalUrl={true}
                >
                    Documentation
                </LinkButton>
                <LinkButton
                    variant="secondary"
                    className="border border-pk-content-tertiary text-pk-content-primary bg-pk-surface-primary"
                    href="https://www.devtool.io/docs/enterprise"
                    isExternalUrl={true}
                >
