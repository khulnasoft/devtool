...
const callbackUrl = () => {
    ...
    return devtoolHostUrl.with({ pathname }).toString();
};
...
const RedirectUrlDescription: FunctionComponent<RedirectUrlDescriptionProps> = ({ type }) => {
    ...
    switch (type) {
        case AuthProviderType.GITHUB:
            docsUrl = `https://www.devtool.io/docs/configure/authentication/github-enterprise`;
            break;
        case AuthProviderType.GITLAB:
            docsUrl = `https://www.devtool.io/docs/configure/authentication/gitlab#registering-a-self-hosted-gitlab-installation`;
            break;
        case AuthProviderType.BITBUCKET:
            docsUrl = `https://www.devtool.io/docs/configure/authentication`;
            break;
        case AuthProviderType.BITBUCKET_SERVER:
            docsUrl = "https://www.devtool.io/docs/configure/authentication/bitbucket-server";
            break;
        case AuthProviderType.AZURE_DEVOPS:
            docsUrl = "https://www.devtool.io/docs/configure/authentication/azure-devops";
            break;
        default:
            return null;
    }
