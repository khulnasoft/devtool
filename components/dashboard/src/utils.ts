...
export function isDevtoolIo() {
    return (
        window.location.hostname === "devtool.io" ||
        window.location.hostname === "devtool-staging.com" ||
        window.location.hostname.endsWith("devtool-dev.com") ||
