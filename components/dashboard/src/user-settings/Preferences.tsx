...
export default function Preferences() {
    ...
    const saveWorkspaceTimeout = useCallback(
        async (e) => {
            ...
            try {
                await getDevtoolService().server.updateWorkspaceTimeoutSetting({
        ...
        <div>
            <PageWithSettingsSubMenu>
                ...
                <Subheading>
                    ...
                    <a
                        className="gp-link"
                        href="https://www.devtool.io/docs/references/ides-and-editors"
                        target="_blank"
                        rel="noreferrer"
                    >
                        Learn more
                ...
                <form className="mt-4 max-w-xl" onSubmit={saveDotfileRepo}>
                    <InputField
                        ...
                        hint="Add a repository URL that includes dotfiles. Devtool will clone and install your dotfiles for every new workspace."
                    >
                    ...
                    <form onSubmit={saveWorkspaceTimeout}>
                        ...
                        >
                            <div className="flex flex-col">
                                ...
                                {creationError && (
                                    <p className="text-devtool-red w-full max-w-lg">
