        ...
        <Modal visible onClose={props.onClose} onSubmit={save}>
            ...
            <ModalBody>
                ...
                <Alert type="info" className="mt-2">
                    ...
                    <a
                        href="https://www.devtool.io/docs/configure/user-settings/ssh#create-an-ssh-key"
                        target="devtool-create-ssh-key-doc"
                        className="gp-link"
                    >
            ...
            <div className="flex items-start sm:justify-between mb-2">
                <div>
                    ...
                    <Subheading>
                        ...
                        <a
                            className="gp-link"
                            href="https://www.devtool.io/docs/configure/user-settings/ssh"
                            target="_blank"
                            rel="noreferrer"
                        >
                            Learn more
