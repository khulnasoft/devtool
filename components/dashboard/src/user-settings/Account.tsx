...
import { getDevtoolService, devtoolHostUrl } from "../service/service";
...
export default function Account() {
    ...
    const deleteAccount = useCallback(async () => {
        await getDevtoolService().server.deleteAccount();
        document.location.href = devtoolHostUrl.asApiLogout().toString();
    }, []);
        ...
        <div>
            ...
            >
                <ol className="text-gray-500 text-sm list-outside list-decimal">
                    ...
                    <li className="ml-5">
                        Your subscription will be cancelled. If you obtained a Devtool subscription through the GitHub
            ...
            <PageWithSettingsSubMenu>
                ...
                <Subheading className="mb-3">
                    This action will remove all the data associated with your account in Devtool.
                </Subheading>
