...
export function SelectAccountModal(
    ...
    const continueWithOtherAccount = () => {
        const accessControlUrl = devtoolHostUrl.asAccessControl().toString();

        const loginUrl = devtoolHostUrl
            .withApi({
                pathname: "/login",
        ...
        const logoutUrl = devtoolHostUrl
            .withApi({
                pathname: "/logout",
        ...
        <Modal visible={true} onClose={props.close}>
            ...
            <ModalBody>
                <p className="pb-2 text-gray-500 text-base">
                    You are trying to authorize a provider that is already connected with another account on Devtool.
                </p>
