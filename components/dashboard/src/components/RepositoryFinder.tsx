...
import { ReactComponent as DevtoolRepositoryTemplate } from "../icons/DevtoolRepositoryTemplate.svg";
import DevtoolRepositoryTemplateSVG from "../icons/DevtoolRepositoryTemplate.svg";
...
const resolveIcon = (contextUrl?: string): string => {
    ...
    return PREDEFINED_REPOS.some((repo) => repo.url === contextUrl) ? DevtoolRepositoryTemplateSVG : RepositorySVG;
};
        ...
        return (
            <div className="flex flex-col overflow-hidden" aria-label={`Demo: ${repo.url}`}>
                <div className="flex items-center">
                    <DevtoolRepositoryTemplate className="w-5 h-5 text-pk-content-tertiary mr-2" />
