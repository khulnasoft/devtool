        ...
        return (
            ...
            >
                <Alert type="warning" className="mt-2">
                    To use Devtool for free you'll need to validate your account with your phone number. This is required
                    to discourage and reduce abuse on Devtool infrastructure.
                </Alert>
