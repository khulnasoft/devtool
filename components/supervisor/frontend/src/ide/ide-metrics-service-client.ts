...
export enum MetricsName {
    SupervisorFrontendClientTotal = "devtool_supervisor_frontend_client_total",
    SupervisorFrontendErrorTotal = "devtool_supervisor_frontend_error_total",
    SupervisorFrontendLoadTotal = "devtool_vscode_web_load_total",
}
