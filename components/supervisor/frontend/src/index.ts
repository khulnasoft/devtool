...
import { WorkspaceInstancePhase } from "@khulnasoft/devtool-protocol";
import { DisposableCollection } from "@khulnasoft/devtool-protocol/lib/util/disposable";
...
LoadingFrame.load().then(async (loading) => {
    ...
    document.title = frontendDashboardServiceClient.latestInfo.workspaceDescription ?? "devtool";
    window.devtool.loggedUserID = frontendDashboardServiceClient.latestInfo.loggedUserId;
    window.devtool.openDesktopIDE = frontendDashboardServiceClient.openDesktopIDE.bind(frontendDashboardServiceClient);
    window.devtool.decrypt = frontendDashboardServiceClient.decrypt.bind(frontendDashboardServiceClient);
    window.devtool.encrypt = frontendDashboardServiceClient.encrypt.bind(frontendDashboardServiceClient);
    window.devtool.isEncryptedData = frontendDashboardServiceClient.isEncryptedData.bind(frontendDashboardServiceClient);
    ...
    (async () => {
        ...
        //#region devtool browser telemetry
