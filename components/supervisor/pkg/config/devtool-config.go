...
func NewConfigService(configLocation string, locationReady <-chan struct{}) *ConfigService {
	return &ConfigService{
		...
		configWatcher: newFileWatcher(func(data []byte) (*devtool.DevtoolConfig, error) {
...
// Observe provides channels triggered whenever the config is changed.
func (service *ConfigService) Observe(ctx context.Context) <-chan *devtool.DevtoolConfig {
