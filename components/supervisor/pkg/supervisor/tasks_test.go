...
func TestTaskManager(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Command: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &skipCommand}, {Init: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &failCommand}, {Init: &failCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &failCommand}, {Init: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &skipCommand}, {Init: &failCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testJSONObjectCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testEscapedJSONObject, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testJSONArrayCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testStringEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testBooleanEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testNullEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			DevtoolTasks: &[]TaskConfig{{Init: &testNumberEnvCommand, Env: exampleEnvVarInputs}},
	...
	for _, test := range tests {
		t.Run(test.Desc, func(t *testing.T) {
			...
			devtoolTasks := ""
			if test.DevtoolTasks != nil {
				result, err := json.Marshal(test.DevtoolTasks)
				if err != nil {
					t.Fatal(err)
				}
				devtoolTasks = string(result)
			}
			...
			var (
				...
				taskManager     = newTasksManager(&Config{
					WorkspaceConfig: WorkspaceConfig{
						DevtoolTasks:    devtoolTasks,
						DevtoolHeadless: strconv.FormatBool(test.Headless),
					},
