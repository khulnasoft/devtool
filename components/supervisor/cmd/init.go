...
import (
	...
	"github.com/khulnasoft/devtool/supervisor/pkg/supervisor"
...
var initCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			log.WithError(err).Fatal("cannot find git executable, make sure it is installed as part of devtool image")
		}
...
func newShutdownLogger() shutdownLogger {
	file := "/workspace/.devtool/supervisor-termination.log"
