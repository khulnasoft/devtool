...
var devtoolHost = os.Getenv("DEVTOOL_HOST")
...
The returned command requires SSH keys to be configured with Devtool.
See %s/user/keys for a guide on setting them up.
`, devtoolHost), RunE: func(cmd *cobra.Command, args []string) error {
