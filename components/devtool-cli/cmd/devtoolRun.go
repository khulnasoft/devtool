...
// devtoolRunCmd represents the devtoolRun command
var devtoolRunCmd = &cobra.Command{
	Use:    "__devtool_run [<pathToExecutable>]",
	Short:  "Used by Devtool to ensure smooth operation",
	Hidden: true,
...
func init() {
	rootCmd.AddCommand(devtoolRunCmd)
}
