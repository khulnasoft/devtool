...
func (x *ListAuditLogsRequest) Reset() {
	*x = ListAuditLogsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devtool_v1_auditlogs_proto_msgTypes[0]
...
func (*ListAuditLogsRequest) Descriptor() ([]byte, []int) {
	return file_devtool_v1_auditlogs_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListAuditLogsResponse) Reset() {
	*x = ListAuditLogsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devtool_v1_auditlogs_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListAuditLogsResponse) Descriptor() ([]byte, []int) {
	return file_devtool_v1_auditlogs_proto_rawDescGZIP(), []int{1}
}
...
func (x *AuditLog) Reset() {
	*x = AuditLog{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devtool_v1_auditlogs_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuditLog) Descriptor() ([]byte, []int) {
	return file_devtool_v1_auditlogs_proto_rawDescGZIP(), []int{2}
}
...
var File_devtool_v1_auditlogs_proto protoreflect.FileDescriptor

var file_devtool_v1_auditlogs_proto_rawDesc = []byte{
...
var (
	file_devtool_v1_auditlogs_proto_rawDescOnce sync.Once
	file_devtool_v1_auditlogs_proto_rawDescData = file_devtool_v1_auditlogs_proto_rawDesc
)

func file_devtool_v1_auditlogs_proto_rawDescGZIP() []byte {
	file_devtool_v1_auditlogs_proto_rawDescOnce.Do(func() {
		file_devtool_v1_auditlogs_proto_rawDescData = protoimpl.X.CompressGZIP(file_devtool_v1_auditlogs_proto_rawDescData)
	})
	return file_devtool_v1_auditlogs_proto_rawDescData
}

var file_devtool_v1_auditlogs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_devtool_v1_auditlogs_proto_goTypes = []interface{}{
	(*ListAuditLogsRequest)(nil),  // 0: devtool.v1.ListAuditLogsRequest
	(*ListAuditLogsResponse)(nil), // 1: devtool.v1.ListAuditLogsResponse
	(*AuditLog)(nil),              // 2: devtool.v1.AuditLog
	(*PaginationRequest)(nil),     // 3: devtool.v1.PaginationRequest
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*PaginationResponse)(nil),    // 5: devtool.v1.PaginationResponse
}
var file_devtool_v1_auditlogs_proto_depIdxs = []int32{
	3, // 0: devtool.v1.ListAuditLogsRequest.pagination:type_name -> devtool.v1.PaginationRequest
	4, // 1: devtool.v1.ListAuditLogsRequest.from:type_name -> google.protobuf.Timestamp
	4, // 2: devtool.v1.ListAuditLogsRequest.to:type_name -> google.protobuf.Timestamp
	5, // 3: devtool.v1.ListAuditLogsResponse.pagination:type_name -> devtool.v1.PaginationResponse
	2, // 4: devtool.v1.ListAuditLogsResponse.audit_logs:type_name -> devtool.v1.AuditLog
	4, // 5: devtool.v1.AuditLog.timestamp:type_name -> google.protobuf.Timestamp
	0, // 6: devtool.v1.AuditLogService.ListAuditLogs:input_type -> devtool.v1.ListAuditLogsRequest
	1, // 7: devtool.v1.AuditLogService.ListAuditLogs:output_type -> devtool.v1.ListAuditLogsResponse
...
func init() { file_devtool_v1_auditlogs_proto_init() }
func file_devtool_v1_auditlogs_proto_init() {
	if File_devtool_v1_auditlogs_proto != nil {
		return
	}
	file_devtool_v1_pagination_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_devtool_v1_auditlogs_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devtool_v1_auditlogs_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devtool_v1_auditlogs_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devtool_v1_auditlogs_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devtool_v1_auditlogs_proto_goTypes,
		DependencyIndexes: file_devtool_v1_auditlogs_proto_depIdxs,
		MessageInfos:      file_devtool_v1_auditlogs_proto_msgTypes,
	}.Build()
	File_devtool_v1_auditlogs_proto = out.File
	file_devtool_v1_auditlogs_proto_rawDesc = nil
	file_devtool_v1_auditlogs_proto_goTypes = nil
	file_devtool_v1_auditlogs_proto_depIdxs = nil
}
