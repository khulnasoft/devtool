...
func (x *CreateTemporaryAccessTokenRequest) Reset() {
	*x = CreateTemporaryAccessTokenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devtool_v1_token_proto_msgTypes[0]
...
func (*CreateTemporaryAccessTokenRequest) Descriptor() ([]byte, []int) {
	return file_devtool_v1_token_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateTemporaryAccessTokenResponse) Reset() {
	*x = CreateTemporaryAccessTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devtool_v1_token_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateTemporaryAccessTokenResponse) Descriptor() ([]byte, []int) {
	return file_devtool_v1_token_proto_rawDescGZIP(), []int{1}
}
...
var File_devtool_v1_token_proto protoreflect.FileDescriptor

var file_devtool_v1_token_proto_rawDesc = []byte{
...
var (
	file_devtool_v1_token_proto_rawDescOnce sync.Once
	file_devtool_v1_token_proto_rawDescData = file_devtool_v1_token_proto_rawDesc
)

func file_devtool_v1_token_proto_rawDescGZIP() []byte {
	file_devtool_v1_token_proto_rawDescOnce.Do(func() {
		file_devtool_v1_token_proto_rawDescData = protoimpl.X.CompressGZIP(file_devtool_v1_token_proto_rawDescData)
	})
	return file_devtool_v1_token_proto_rawDescData
}

var file_devtool_v1_token_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_devtool_v1_token_proto_goTypes = []interface{}{
	(*CreateTemporaryAccessTokenRequest)(nil),  // 0: devtool.v1.CreateTemporaryAccessTokenRequest
	(*CreateTemporaryAccessTokenResponse)(nil), // 1: devtool.v1.CreateTemporaryAccessTokenResponse
}
var file_devtool_v1_token_proto_depIdxs = []int32{
	0, // 0: devtool.v1.TokenService.CreateTemporaryAccessToken:input_type -> devtool.v1.CreateTemporaryAccessTokenRequest
	1, // 1: devtool.v1.TokenService.CreateTemporaryAccessToken:output_type -> devtool.v1.CreateTemporaryAccessTokenResponse
...
func init() { file_devtool_v1_token_proto_init() }
func file_devtool_v1_token_proto_init() {
	if File_devtool_v1_token_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devtool_v1_token_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devtool_v1_token_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devtool_v1_token_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devtool_v1_token_proto_goTypes,
		DependencyIndexes: file_devtool_v1_token_proto_depIdxs,
		MessageInfos:      file_devtool_v1_token_proto_msgTypes,
	}.Build()
	File_devtool_v1_token_proto = out.File
	file_devtool_v1_token_proto_rawDesc = nil
	file_devtool_v1_token_proto_goTypes = nil
	file_devtool_v1_token_proto_depIdxs = nil
}
