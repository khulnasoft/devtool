...
public class SCMServiceClient(
  ...
  override suspend fun searchSCMTokens(request: Scm.SearchSCMTokensRequest, headers: Headers):
    ...
    "devtool.v1.SCMService/SearchSCMTokens",
      io.devtool.publicapi.v1.Scm.SearchSCMTokensRequest::class,
      io.devtool.publicapi.v1.Scm.SearchSCMTokensResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun guessTokenScopes(request: Scm.GuessTokenScopesRequest, headers: Headers):
    ...
    "devtool.v1.SCMService/GuessTokenScopes",
      io.devtool.publicapi.v1.Scm.GuessTokenScopesRequest::class,
      io.devtool.publicapi.v1.Scm.GuessTokenScopesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun searchRepositories(request: Scm.SearchRepositoriesRequest, headers: Headers):
    ...
    "devtool.v1.SCMService/SearchRepositories",
      io.devtool.publicapi.v1.Scm.SearchRepositoriesRequest::class,
      io.devtool.publicapi.v1.Scm.SearchRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listSuggestedRepositories(request: Scm.ListSuggestedRepositoriesRequest,
    ...
    "devtool.v1.SCMService/ListSuggestedRepositories",
      io.devtool.publicapi.v1.Scm.ListSuggestedRepositoriesRequest::class,
      io.devtool.publicapi.v1.Scm.ListSuggestedRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
