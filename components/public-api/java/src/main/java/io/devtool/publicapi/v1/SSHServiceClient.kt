...
public class SSHServiceClient(
  ...
  override suspend fun listSSHPublicKeys(request: Ssh.ListSSHPublicKeysRequest, headers: Headers):
    ...
    "devtool.v1.SSHService/ListSSHPublicKeys",
      io.devtool.publicapi.v1.Ssh.ListSSHPublicKeysRequest::class,
      io.devtool.publicapi.v1.Ssh.ListSSHPublicKeysResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createSSHPublicKey(request: Ssh.CreateSSHPublicKeyRequest, headers: Headers):
    ...
    "devtool.v1.SSHService/CreateSSHPublicKey",
      io.devtool.publicapi.v1.Ssh.CreateSSHPublicKeyRequest::class,
      io.devtool.publicapi.v1.Ssh.CreateSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteSSHPublicKey(request: Ssh.DeleteSSHPublicKeyRequest, headers: Headers):
    ...
    "devtool.v1.SSHService/DeleteSSHPublicKey",
      io.devtool.publicapi.v1.Ssh.DeleteSSHPublicKeyRequest::class,
      io.devtool.publicapi.v1.Ssh.DeleteSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
