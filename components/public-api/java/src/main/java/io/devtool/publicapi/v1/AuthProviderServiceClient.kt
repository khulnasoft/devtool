...
public class AuthProviderServiceClient(
  ...
  override suspend fun createAuthProvider(request: Authprovider.CreateAuthProviderRequest,
    ...
    "devtool.v1.AuthProviderService/CreateAuthProvider",
      io.devtool.publicapi.v1.Authprovider.CreateAuthProviderRequest::class,
      io.devtool.publicapi.v1.Authprovider.CreateAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getAuthProvider(request: Authprovider.GetAuthProviderRequest,
    ...
    "devtool.v1.AuthProviderService/GetAuthProvider",
      io.devtool.publicapi.v1.Authprovider.GetAuthProviderRequest::class,
      io.devtool.publicapi.v1.Authprovider.GetAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listAuthProviders(request: Authprovider.ListAuthProvidersRequest,
    ...
    "devtool.v1.AuthProviderService/ListAuthProviders",
      io.devtool.publicapi.v1.Authprovider.ListAuthProvidersRequest::class,
      io.devtool.publicapi.v1.Authprovider.ListAuthProvidersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.AuthProviderService/ListAuthProviderDescriptions",
      io.devtool.publicapi.v1.Authprovider.ListAuthProviderDescriptionsRequest::class,
      io.devtool.publicapi.v1.Authprovider.ListAuthProviderDescriptionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateAuthProvider(request: Authprovider.UpdateAuthProviderRequest,
    ...
    "devtool.v1.AuthProviderService/UpdateAuthProvider",
      io.devtool.publicapi.v1.Authprovider.UpdateAuthProviderRequest::class,
      io.devtool.publicapi.v1.Authprovider.UpdateAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteAuthProvider(request: Authprovider.DeleteAuthProviderRequest,
    ...
    "devtool.v1.AuthProviderService/DeleteAuthProvider",
      io.devtool.publicapi.v1.Authprovider.DeleteAuthProviderRequest::class,
      io.devtool.publicapi.v1.Authprovider.DeleteAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
