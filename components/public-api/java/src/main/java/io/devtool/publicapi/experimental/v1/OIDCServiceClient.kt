...
public class OIDCServiceClient(
  ...
  override suspend fun createClientConfig(request: Oidc.CreateClientConfigRequest,
    ...
    "devtool.experimental.v1.OIDCService/CreateClientConfig",
      io.devtool.publicapi.experimental.v1.Oidc.CreateClientConfigRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.CreateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getClientConfig(request: Oidc.GetClientConfigRequest, headers: Headers):
    ...
    "devtool.experimental.v1.OIDCService/GetClientConfig",
      io.devtool.publicapi.experimental.v1.Oidc.GetClientConfigRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.GetClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listClientConfigs(request: Oidc.ListClientConfigsRequest, headers: Headers):
    ...
    "devtool.experimental.v1.OIDCService/ListClientConfigs",
      io.devtool.publicapi.experimental.v1.Oidc.ListClientConfigsRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.ListClientConfigsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateClientConfig(request: Oidc.UpdateClientConfigRequest,
    ...
    "devtool.experimental.v1.OIDCService/UpdateClientConfig",
      io.devtool.publicapi.experimental.v1.Oidc.UpdateClientConfigRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.UpdateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteClientConfig(request: Oidc.DeleteClientConfigRequest,
    ...
    "devtool.experimental.v1.OIDCService/DeleteClientConfig",
      io.devtool.publicapi.experimental.v1.Oidc.DeleteClientConfigRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.DeleteClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setClientConfigActivation(request: Oidc.SetClientConfigActivationRequest,
    ...
    "devtool.experimental.v1.OIDCService/SetClientConfigActivation",
      io.devtool.publicapi.experimental.v1.Oidc.SetClientConfigActivationRequest::class,
      io.devtool.publicapi.experimental.v1.Oidc.SetClientConfigActivationResponse::class,
      StreamType.UNARY,
    ),
  )
