...
public class PrebuildServiceClient(
  ...
  override suspend fun startPrebuild(request: PrebuildOuterClass.StartPrebuildRequest,
    ...
    "devtool.v1.PrebuildService/StartPrebuild",
      io.devtool.publicapi.v1.PrebuildOuterClass.StartPrebuildRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.StartPrebuildResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun cancelPrebuild(request: PrebuildOuterClass.CancelPrebuildRequest,
    ...
    "devtool.v1.PrebuildService/CancelPrebuild",
      io.devtool.publicapi.v1.PrebuildOuterClass.CancelPrebuildRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.CancelPrebuildResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getPrebuild(request: PrebuildOuterClass.GetPrebuildRequest,
    ...
    "devtool.v1.PrebuildService/GetPrebuild",
      io.devtool.publicapi.v1.PrebuildOuterClass.GetPrebuildRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.GetPrebuildResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listPrebuilds(request: PrebuildOuterClass.ListPrebuildsRequest,
    ...
    "devtool.v1.PrebuildService/ListPrebuilds",
      io.devtool.publicapi.v1.PrebuildOuterClass.ListPrebuildsRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.ListPrebuildsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun watchPrebuild(headers: Headers):
    ...
    "devtool.v1.PrebuildService/WatchPrebuild",
      io.devtool.publicapi.v1.PrebuildOuterClass.WatchPrebuildRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.WatchPrebuildResponse::class,
      StreamType.SERVER,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.PrebuildService/ListOrganizationPrebuilds",
      io.devtool.publicapi.v1.PrebuildOuterClass.ListOrganizationPrebuildsRequest::class,
      io.devtool.publicapi.v1.PrebuildOuterClass.ListOrganizationPrebuildsResponse::class,
      StreamType.UNARY,
    ),
  )
