...
public class EditorServiceClient(
  ...
  override suspend fun listEditorOptions(request: EditorServiceOuterClass.ListEditorOptionsRequest,
    ...
    "devtool.experimental.v1.EditorService/ListEditorOptions",
      io.devtool.publicapi.experimental.v1.EditorServiceOuterClass.ListEditorOptionsRequest::class,
      io.devtool.publicapi.experimental.v1.EditorServiceOuterClass.ListEditorOptionsResponse::class,
      StreamType.UNARY,
    ),
  )
