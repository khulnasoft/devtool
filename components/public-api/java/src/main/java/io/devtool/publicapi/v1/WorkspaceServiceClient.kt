...
public class WorkspaceServiceClient(
  ...
  override suspend fun getWorkspace(request: WorkspaceOuterClass.GetWorkspaceRequest,
    ...
    "devtool.v1.WorkspaceService/GetWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun watchWorkspaceStatus(headers: Headers):
    ...
    "devtool.v1.WorkspaceService/WatchWorkspaceStatus",
      io.devtool.publicapi.v1.WorkspaceOuterClass.WatchWorkspaceStatusRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.WatchWorkspaceStatusResponse::class,
      StreamType.SERVER,
    ),
  )
  ...
  override suspend fun listWorkspaces(request: WorkspaceOuterClass.ListWorkspacesRequest,
    ...
    "devtool.v1.WorkspaceService/ListWorkspaces",
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspacesRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspacesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/ListWorkspaceSessions",
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspaceSessionsRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspaceSessionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/CreateAndStartWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.CreateAndStartWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.CreateAndStartWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun startWorkspace(request: WorkspaceOuterClass.StartWorkspaceRequest,
    ...
    "devtool.v1.WorkspaceService/StartWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.StartWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.StartWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateWorkspace(request: WorkspaceOuterClass.UpdateWorkspaceRequest,
    ...
    "devtool.v1.WorkspaceService/UpdateWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.UpdateWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.UpdateWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun stopWorkspace(request: WorkspaceOuterClass.StopWorkspaceRequest,
    ...
    "devtool.v1.WorkspaceService/StopWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.StopWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.StopWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteWorkspace(request: WorkspaceOuterClass.DeleteWorkspaceRequest,
    ...
    "devtool.v1.WorkspaceService/DeleteWorkspace",
      io.devtool.publicapi.v1.WorkspaceOuterClass.DeleteWorkspaceRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.DeleteWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/ListWorkspaceClasses",
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspaceClassesRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.ListWorkspaceClassesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun parseContextURL(request: WorkspaceOuterClass.ParseContextURLRequest,
    ...
    "devtool.v1.WorkspaceService/ParseContextURL",
      io.devtool.publicapi.v1.WorkspaceOuterClass.ParseContextURLRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.ParseContextURLResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/GetWorkspaceDefaultImage",
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceDefaultImageRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceDefaultImageResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun sendHeartBeat(request: WorkspaceOuterClass.SendHeartBeatRequest,
    ...
    "devtool.v1.WorkspaceService/SendHeartBeat",
      io.devtool.publicapi.v1.WorkspaceOuterClass.SendHeartBeatRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.SendHeartBeatResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/GetWorkspaceOwnerToken",
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceOwnerTokenRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceOwnerTokenResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/GetWorkspaceEditorCredentials",
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceEditorCredentialsRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.GetWorkspaceEditorCredentialsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/CreateWorkspaceSnapshot",
      io.devtool.publicapi.v1.WorkspaceOuterClass.CreateWorkspaceSnapshotRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.CreateWorkspaceSnapshotResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.WorkspaceService/WaitForWorkspaceSnapshot",
      io.devtool.publicapi.v1.WorkspaceOuterClass.WaitForWorkspaceSnapshotRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.WaitForWorkspaceSnapshotResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateWorkspacePort(request: WorkspaceOuterClass.UpdateWorkspacePortRequest,
    ...
    "devtool.v1.WorkspaceService/UpdateWorkspacePort",
      io.devtool.publicapi.v1.WorkspaceOuterClass.UpdateWorkspacePortRequest::class,
      io.devtool.publicapi.v1.WorkspaceOuterClass.UpdateWorkspacePortResponse::class,
      StreamType.UNARY,
    ),
  )
