...
public class UserServiceClient(
  ...
  override suspend fun getAuthenticatedUser(request: UserOuterClass.GetAuthenticatedUserRequest,
    ...
    "devtool.v1.UserService/GetAuthenticatedUser",
      io.devtool.publicapi.v1.UserOuterClass.GetAuthenticatedUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.GetAuthenticatedUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateUser(request: UserOuterClass.UpdateUserRequest, headers: Headers):
    ...
    "devtool.v1.UserService/UpdateUser",
      io.devtool.publicapi.v1.UserOuterClass.UpdateUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.UpdateUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devtool.v1.UserService/SetWorkspaceAutoStartOptions",
      io.devtool.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteUser(request: UserOuterClass.DeleteUserRequest, headers: Headers):
    ...
    "devtool.v1.UserService/DeleteUser",
      io.devtool.publicapi.v1.UserOuterClass.DeleteUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.DeleteUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun verifyUser(request: UserOuterClass.VerifyUserRequest, headers: Headers):
    ...
    "devtool.v1.UserService/VerifyUser",
      io.devtool.publicapi.v1.UserOuterClass.VerifyUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.VerifyUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun blockUser(request: UserOuterClass.BlockUserRequest, headers: Headers):
    ...
    "devtool.v1.UserService/BlockUser",
      io.devtool.publicapi.v1.UserOuterClass.BlockUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.BlockUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listUsers(request: UserOuterClass.ListUsersRequest, headers: Headers):
    ...
    "devtool.v1.UserService/ListUsers",
      io.devtool.publicapi.v1.UserOuterClass.ListUsersRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.ListUsersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getUser(request: UserOuterClass.GetUserRequest, headers: Headers):
    ...
    "devtool.v1.UserService/GetUser",
      io.devtool.publicapi.v1.UserOuterClass.GetUserRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.GetUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setRolesOrPermissions(request: UserOuterClass.SetRolesOrPermissionsRequest,
    ...
    "devtool.v1.UserService/SetRolesOrPermissions",
      io.devtool.publicapi.v1.UserOuterClass.SetRolesOrPermissionsRequest::class,
      io.devtool.publicapi.v1.UserOuterClass.SetRolesOrPermissionsResponse::class,
      StreamType.UNARY,
    ),
  )
