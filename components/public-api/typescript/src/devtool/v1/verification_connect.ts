...
/**
 * @generated from service devtool.v1.VerificationService
 */
export const VerificationService = {
  typeName: "devtool.v1.VerificationService",
  methods: {
    /**
     * SendPhoneNumberVerificationToken sends a verification token to the
     * specified phone number.
     *
     * @generated from rpc devtool.v1.VerificationService.SendPhoneNumberVerificationToken
     */
     ...
     * token.
     *
     * @generated from rpc devtool.v1.VerificationService.VerifyPhoneNumberVerificationToken
     */
