...
// @generated from file devtool/v1/error.proto (package devtool.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message devtool.v1.PermissionDeniedDetails
 */
export class PermissionDeniedDetails extends Message<PermissionDeniedDetails> {
  /**
   * @generated from oneof devtool.v1.PermissionDeniedDetails.reason
   */
  reason: {
    /**
     * @generated from field: devtool.v1.UserBlockedError user_blocked = 1;
     */
    value: UserBlockedError;
    case: "userBlocked";
  } | {
    /**
     * @generated from field: devtool.v1.NeedsVerificationError needs_verification = 2;
     */
  ...
  static readonly typeName = "devtool.v1.PermissionDeniedDetails";
...
/**
 * @generated from message devtool.v1.UserBlockedError
 */
export class UserBlockedError extends Message<UserBlockedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.UserBlockedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devtool.v1.NeedsVerificationError
 */
export class NeedsVerificationError extends Message<NeedsVerificationError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.NeedsVerificationError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message devtool.v1.FailedPreconditionDetails
 */
export class FailedPreconditionDetails extends Message<FailedPreconditionDetails> {
  /**
   * @generated from oneof devtool.v1.FailedPreconditionDetails.reason
   */
  reason: {
    /**
     * @generated from field: devtool.v1.PaymentSpendingLimitReachedError payment_spending_limit_reached = 1;
     */
    value: PaymentSpendingLimitReachedError;
    case: "paymentSpendingLimitReached";
  } | {
    /**
     * @generated from field: devtool.v1.InvalidCostCenterError invalid_cost_center = 2;
     */
    value: InvalidCostCenterError;
    case: "invalidCostCenter";
  } | {
    /**
     * @generated from field: devtool.v1.TooManyRunningWorkspacesError too_many_running_workspaces = 3;
     */
    value: TooManyRunningWorkspacesError;
    case: "tooManyRunningWorkspaces";
  } | {
    /**
     * @generated from field: devtool.v1.InvalidDevtoolYMLError invalid_devtool_yml = 4;
     */
    value: InvalidDevtoolYMLError;
    case: "invalidDevtoolYml";
  } | {
    /**
     * @generated from field: devtool.v1.RepositoryNotFoundError repository_not_found = 5;
     */
    value: RepositoryNotFoundError;
    case: "repositoryNotFound";
  } | {
    /**
     * @generated from field: devtool.v1.RepositoryUnauthorizedError repository_unauthorized = 6;
     */
    value: RepositoryUnauthorizedError;
    case: "repositoryUnauthorized";
  } | {
    /**
     * @generated from field: devtool.v1.ImageBuildLogsNotYetAvailableError image_build_logs_not_yet_available = 7;
     */
    value: ImageBuildLogsNotYetAvailableError;
    case: "imageBuildLogsNotYetAvailable";
  } | {
    /**
     * @generated from field: devtool.v1.CellDisabledError cell_is_disabled = 8;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.FailedPreconditionDetails";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "invalid_devtool_yml", kind: "message", T: InvalidDevtoolYMLError, oneof: "reason" },
...
/**
 * @generated from message devtool.v1.PaymentSpendingLimitReachedError
 */
export class PaymentSpendingLimitReachedError extends Message<PaymentSpendingLimitReachedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.PaymentSpendingLimitReachedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devtool.v1.InvalidCostCenterError
 */
export class InvalidCostCenterError extends Message<InvalidCostCenterError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.InvalidCostCenterError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devtool.v1.TooManyRunningWorkspacesError
 */
export class TooManyRunningWorkspacesError extends Message<TooManyRunningWorkspacesError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.TooManyRunningWorkspacesError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devtool.v1.InvalidDevtoolYMLError
 */
export class InvalidDevtoolYMLError extends Message<InvalidDevtoolYMLError> {
  /**
   * @generated from field: repeated string violations = 1;
   */
  violations: string[] = [];

  constructor(data?: PartialMessage<InvalidDevtoolYMLError>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.InvalidDevtoolYMLError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "violations", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InvalidDevtoolYMLError {
    return new InvalidDevtoolYMLError().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InvalidDevtoolYMLError {
    return new InvalidDevtoolYMLError().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InvalidDevtoolYMLError {
    return new InvalidDevtoolYMLError().fromJsonString(jsonString, options);
  }

  static equals(a: InvalidDevtoolYMLError | PlainMessage<InvalidDevtoolYMLError> | undefined, b: InvalidDevtoolYMLError | PlainMessage<InvalidDevtoolYMLError> | undefined): boolean {
    return proto3.util.equals(InvalidDevtoolYMLError, a, b);
  }
}

/**
 * @generated from message devtool.v1.RepositoryNotFoundError
 */
export class RepositoryNotFoundError extends Message<RepositoryNotFoundError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.RepositoryNotFoundError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devtool.v1.RepositoryUnauthorizedError
 */
export class RepositoryUnauthorizedError extends Message<RepositoryUnauthorizedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.RepositoryUnauthorizedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "host", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devtool.v1.ImageBuildLogsNotYetAvailableError
 */
export class ImageBuildLogsNotYetAvailableError extends Message<ImageBuildLogsNotYetAvailableError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.ImageBuildLogsNotYetAvailableError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devtool.v1.CellDisabledError
 */
export class CellDisabledError extends Message<CellDisabledError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devtool.v1.CellDisabledError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
