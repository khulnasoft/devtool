...
pushd "go"
  go install github.com/khulnasoft/devtool/components/public-api/go/protoc-proxy-gen
popd
...
buf breaking --against "https://github.com/khulnasoft/devtool.git#branch=main,subdir=components/public-api"
